...
export default function Home() {
  ...
  return (
    <div>
    <Head>
      <title>Al Zoldyck UI Generator</title>
      {/* Add any additional head elements here */}
    </Head>
    <nav className="bg-gray-800 p-4">
      <div className="container mx-auto text-center">
        <h1 href="/" className="text-white text-lg  font-bold">Quick UI Generator with Al Zoldyck UI</h1>
      </div>
    </nav>
    ...
    <div className="bg-green-600 text-white text-center py-10">
      <div className="md:w-2/3 mx-auto">
        <h2 className="text-3xl md:text-4xl font-bold mb-4">Transform Your Ideas Into Real, Polished UI</h2>
        <p className="text-xl mb-6 flex flex-col justify-center items-center max-w-xl w-full mx-auto">
        <img src="/al01.jpg" id="img" alt="Footer Icon" className="footer-icon" />
        </p>
        <button
